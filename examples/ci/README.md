...
- **Supply-chain hygiene.** These examples pin GitHub-official actions to major
  ...
  commit SHAs. The gate uses the canonical Marketplace action
  [`Therealdk8890/dprovenancekit-action@v1`](https://github.com/marketplace/actions/dprovenancekit-regression-gate);
